...
const AddServices = () => {
    ...
    const WomenCategories = ['Hair Cut', 'Hair Wash', 'Hair Styling', 'Hair Colour', 'Hi lites', 'Eye Brows', 'Eye Lashes', 'Eye Brows/Eyes Lashes', 'EyeBrows & lashes', 'Threading', 'Waxing', 'Waxing (REGULAR)', 'Waxing (LIPO)', 'Waxing (STRIPLESS)', 'Womens Cut and Dry', 'Treatments N Ritual', "Women's Color Play", "Texture N Turn", 'Spa']
