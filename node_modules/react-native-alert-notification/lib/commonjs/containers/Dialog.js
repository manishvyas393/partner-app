  ...
  constructor(props) {
    ...
    _defineProperty(this, "_open", async config => {
      if (this.state.visible) {
        ...
        await this._startAnimation(_ENV.ACTION.CLOSE, false);
    ...
    _defineProperty(this, "_startAnimation", (action, opacity = true) => {
      const open = action === _ENV.ACTION.OPEN;
      let animations = [opacity ? _reactNative.Animated.timing(this._opacity, {
        toValue: action === _ENV.ACTION.OPEN ? 1 : 0,
        duration: 300,
        useNativeDriver: false
      }) : null, _reactNative.Animated[open ? 'spring' : 'timing'](this._positionDialog, {
        toValue: open ? _ENV.default.WINDOWS.HEIGHT / 2 - this._popupHeight / 2 : _ENV.default.WINDOWS.HEIGHT + 30,
        ...(open ? {
          bounciness: 12
        } : {
          duration: 250
    ...
    _defineProperty(this, "_buttonRender", () => {
      ...
      if (button) {
        return /*#__PURE__*/React.createElement(_reactNative.TouchableOpacity, {
          ...
          onPress: onPressButton !== null && onPressButton !== void 0 ? onPressButton : this._close
    ...
    this._positionDialog = new _reactNative.Animated.Value(_ENV.default.WINDOWS.HEIGHT + 30);
    this._popupHeight = 0;
    this.state = {
